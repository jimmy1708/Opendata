...
* IDENTIFIANT : VilleMTP_MTP_CameraSurv

* DESCRIPTION : Date d’installation et emplacement des 141 caméras de vidéoprotection urbaine de la Ville de Montpellier. Le fichier renseigne pour chacune des 141 caméras, la date d’installation, le lieu, la situation précise dans certains cas, le quartier, le sous-quartier et enfin les coordonnées géographiques pour 141 caméras.
