...
* TITRE : Sous-quartiers

* IDENTIFIANT : VilleMTP_MTP_SousQuartiers

* DESCRIPTION : Cette donnée représente le découpage administratif en sous-quartier de la ville de Montpellier.

* COUVERTUTE GÉOGRAPHIQUE : Ville de Montpellier

* LANGUE : français

* DATE PUBLICATION : 2011-10-11
...
* THÈME INSPIRE : Frontières, limites

* LICENCE : LICENCE OUVERTE / OPEN LICENCE http://www.etalab.gouv.fr/pages/licence-ouverte-open-licence-5899923.html

* MOTS CLÉS : quartier ; sous-quartiers ; découpage ; administratif ; limite ; montpellier
